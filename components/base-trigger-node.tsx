...
import { type NodeStatus, NodeStatusIndicator } from "./react-flow/node-status-indicator";
...
export const BaseTriggerNode = memo(({id, name, icon: Icon, description, status = "initial", children, onSetting, onDoubleClick}: BaseTriggerNodeProps) => {
